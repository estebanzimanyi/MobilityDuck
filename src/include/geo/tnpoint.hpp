...
struct TnpointFunctions {
    static bool StringToTnpoint(Vector &source, Vector &result, idx_t count, CastParameters &parameters);
    static bool TnpointToString(Vector &source, Vector &result, idx_t count, CastParameters &parameters);
